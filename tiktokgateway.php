...
system('clear');
$baner = $yellow."\n
Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9nYXRld2F5LmdvbGlrZS5uZXRcL2FwaVwvbG9naW4iLCJpYXQiOjE3MTAzMTIzODYsImV4cCI6MTc0MTg0ODM4NiwibmJmIjoxNzEwMzEyMzg2LCJqdGkiOiJwQnFYNUNTcGVsRWFXQmlkIiwic3ViIjoyMTYzMjUxLCJwcnYiOiJiOTEyNzk5NzhmMTFhYTdiYzU2NzA0ODdmZmYwMWUyMjgyNTNmZTQ4In0.eT3OgyjvWCfkSMHKtTx47fyyjgBtMbVlAbnMNiiZmds
t	VFZSamVFMUVUWGhPUkZVeVRtYzlQUT09  
...
$baner = $yellow."\n
   ".$res."$ngay/$thang/$nam
                         ░     ".$blud.">>Tool of Hiếu_Zzoikild<<\n\n";
 
$mt = $yellow."~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n";
 
cc($baner);
echo $green."             Tool ZOI    \n         youtube:Hiếu_Zzoikild \n";
cc($mt);
